...
export class HabitacionService {
  ...
  // ==============================================================================
  private getRoomInfo(categoria: string): { imageUrl: string; description: string; amenities: string[]; capacity: number } {
    ...
    if (cat.includes('individual') || cat.includes('simple')) {
      return {
        imageUrl: 'images/individual.jpeg',
